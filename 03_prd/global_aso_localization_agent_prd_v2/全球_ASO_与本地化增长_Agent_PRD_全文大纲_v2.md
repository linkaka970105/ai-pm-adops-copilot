...
| 范围 | 状态 | 说明 |
| --- | --- | --- |
| 第 0 章 | V2 重生成草案，待评审 | 补齐读者矩阵、项目状态和六类审计附件 |
| 第 1 章 | V2 阶段性草案，待最终回填 | 补齐 MVP 输入—处理—输出—责任表；第 2—21 章冻结后更新 |
| 第 2 章 | V2 重生成草案，待评审 | 补齐问题证据—验证—决策路线 |
...
| --- | --- | --- | --- | --- |
| 0 文档治理 | 读者矩阵；项目设定；角色边界；版本记录；事实/假设/决策；术语；审计附件 | 读者、关注点、产物；方案设定、状态；负责、不负责、权限；来源、owner、截止时间 | 阶段图；证据追溯链 | 项目性质、禁止声称和来源版本清楚 |
| 1 一页摘要 | 用户任务痛点；AI/规则/工具/人工边界；MVP 责任链；指标风险前提；关键决策；证据强度 | 用户、场景、任务、失败后果；输入、处理、输出对象、人工责任、失败状态 | 端到端 MVP 图 | 一页形成完整决策链，未把目标写成结果 |
| 2 问题定义 | 方案供给对比；角色输入输出；As-Is 任务链；痛点根因；基线；优先级；不做成本；验证路线 | 现象、根因、用户/业务影响、证据；口径、方法；待证明结论、反证、下一决策 | As-Is 流程；信息断点图 | 现象、根因和证据等级分开 |
...
| 17 分析归因 | 事件/Trace；漏斗；看板；诊断树；归因手段；实验卡；复盘决策 | request/trace、对象/版本、组件版本、人工动作、业务结果；主变量、对照、干扰、停止规则 | 指标下降诊断树；单变量实验 Case | 相关性不写成因果，能定位第一处变化 |
...
# 0. 文档说明与项目总览【P0｜V2 重生成草案】

**章节目标：** 建立全文的生产契约，明确项目性质、事实边界、当前阶段、作者职责和引用规则，防止后续把概念方案、公司公开能力或模拟数据写成个人上线成果。

**核心内容：**

- 0.1 文档目的、读者、适用范围与分章评审方式；
- 0.2 项目名称、定位、类型、阶段、核心用户和一期场景；
- 0.3 方向确认、竞品分析、PRD、PoC、真实试点的阶段关系；
- 0.4 作者、ASO 运营、增长产品、本地化、设计、研发、安全和发布者的职责边界；
- 0.5 文档版本与变更规则；
- 0.6 事实、推断、假设、建议、风险、待决策和待补充台账；
- 0.7 ASO、Growth Task、Evidence Object、ASO Growth State 等术语；
- 0.8 来源—证据—策略—实验—学习的追溯规则。

**关键产物 / Gate：**

- 项目基本信息表、角色边界表、事实与决策台账；
- 统一标签和证据引用方式；
- 未确认项目性质时，不允许进入简历结果表述。

# 1. 一页纸项目摘要【P0｜V2 阶段性草案，最后定稿】
...
- 1.1 一句话产品定位；
- 1.2 第一优先用户、决策用户、协作用户和核心场景；
- 1.3 业务价值、用户价值和 AI 增量价值；
- 1.4 Google Play 单 App × 双市场的 MVP 闭环与核心交付包；
- 1.5 效率、决策质量、AI 效果、安全和业务观察指标；
- 1.6 固定工作流、Evidence Object、人工发布等关键产品决策；
- 1.7 当前证据强度与待验证重点。
...
# 2. 业务背景与问题定义【P0｜V2 重生成草案】

**章节目标：** 证明问题来自真实业务链路，而不是从“大模型能做什么”倒推需求。

**核心内容：**

- 2.1 商店页在“被发现—理解—下载”链路中的位置；
- 2.2 ASO 平台、本地化服务、通用模型、商店实验和人工专家的能力边界；
- 2.3 As-Is 角色、流程和任务链；
- 2.4 数据分散、本地化失真、资产割裂、实验难归因、多市场状态失控和 AI 不可信；
- 2.5 痛点—现象—根因—影响—证据；
- 2.6 当前缺失的工时、返工、证据覆盖和实验质量基线；
- 2.7 不解决成本、替代方案和北极星问题。

**关键产物 / Gate：**

- As-Is 流程图、角色责任表、痛点根因表和基线采集计划；
- 明确哪些结论来自已有材料，哪些仍需访谈和任务观察。
...
- 3.4 三类场景：新市场进入、评论驱动迭代、商店页实验规划与复盘；
...
- 4.6 Evidence Object、跨模态“需求—搜索—表达—实验”、ASO Growth State 的差异化；
...
- 5.3 市场机会卡、评论证据、关键词意图、metadata、Creative Brief、风险清单和实验卡；
- 5.4 P0 / P1 / P2 功能范围；
...
- 7.10 单变量 Experiment Card、结果回流与 Learning State；
- 7.11 埋点、权限、依赖和功能验收。
...
- 11.7 Evidence、Strategy Proposal 和 Experiment Card Schema；
...
- 16.1 评论、关键词、竞品、metadata、Creative Brief 和实验卡任务定义；
...
- 埋点与指标表、实验卡、归因树、Learning Schema 和复盘模板；
