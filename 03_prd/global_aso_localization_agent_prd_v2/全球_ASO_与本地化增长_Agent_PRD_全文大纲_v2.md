...
- 3.1 用户分层与目标用户选择；
- 3.2 核心用户画像、任务目标、约束、成功体验与 JTBD；
- 3.3 用户旅程地图及各阶段目标与问题；
- 3.4 三类典型场景、需求证据、研究计划与反例；
- 3.5 用户需求清单、优先级与判断依据。

**关键产物 / Gate：**

- 用户分层、画像、旅程图、JTBD、场景证据、研究计划和需求优先级；
- 当前为研究假设版；在没有真实访谈前，画像和优先级不得写成已验证结论。

# 4. 产品策略与 AI 必要性论证【P0｜待评审】

**章节目标：** 回答为什么做“商店增长决策 Agent”，而不是翻译工具、关键词平台、报告 Copilot 或纯人工流程优化。

**核心内容：**

- 4.1 产品愿景、Evidence Object / Growth State 策略和边界；
- 4.2 As-Is / To-Be 流程对比与人工责任；
- 4.3 公开竞品事实、本项目推断及 AI 增量价值；
- 4.4 AI 应解决与不应解决的任务；
- 4.5 效率、质量、信任、验证与复用价值假设；
- 4.6 延后、人工、SOP、规则、搜索、自动化、传统算法、AI 和混合方案比较及重评条件；
- 4.7 数据、文化、成本、冷启动、归因和生产责任约束。
...
- 5.1 产品目标与非目标；
- 5.2 业务、任务、用户、AI/规则、安全、成本与稳定指标；
- 5.3 指标定义、分子分母、数据来源、基线、目标和责任人；
- 5.4 Google Play、单 App、双市场 MVP 范围及 P0 / P1 / P2 取舍；
- 5.5 一期明确不做的范围与高自治边界；
- 5.6 研究、PoC、MVP、受控试点、范围扩展和受控自动化路线；
- 5.7 成功、失败、停止/回滚条件与 Gate A 状态。

**关键产物 / Gate：**

- 目标/非目标、MVP 决策表、指标字典、停止条件和 Roadmap；
- Gate A 当前待评审；仍需冻结首个 App 品类、双市场、MVP 交付形态、数据和母语审核资源。

# 6. 信息架构与整体体验设计【P0｜已生成待评审】

章节目标：把产品从“一个聊天框”设计成围绕任务、证据、版本、审核和验证状态协作的增长工作台。

核心内容：

- 6.1 产品信息架构与 Growth Task、Evidence、Listing Version、Validation、Learning 等对象关系；
- 6.2 包含补件、证据不足、人工审核和三类验证路径的 To-Be 用户旅程；
- 6.3 Growth Task、证据、版本策略、审核交付、验证结果、学习和质量管理页面；
- 6.4 三栏版本策略工作台，以及加载、补件、无证据、冲突、无权限、降级和并发状态；
- 6.5 用户输入、AI 输出、多角色人工确认与修改审计；
- 6.6 证据、估算、冲突、过期和降级状态的展示与可编辑版本机制；
- 6.7 分角色纠错、争议升级、Learning 候选与 Bad Case 入口。

关键产物 / Gate：对象关系图、信息架构图、To-Be 旅程、页面清单和原型状态表；低保真原型仍待作者本人绘制。

# 7. 核心功能 PRD【P0｜已生成待评审】

章节目标：逐项定义从创建任务到版本验证和学习回流的功能闭环，使研发、测试和业务评审能够据此执行。

核心内容：

- 7.1 功能优先级、依赖顺序与通用完成标准；
- 7.2 F1 Growth Task 受理、权限与输入校验、数据快照和幂等；
- 7.3 F2 Evidence Object、Market Opportunity Card、多源证据状态与 AI/规则/人工边界；
- 7.4 F3 metadata、Creative Brief、Version Plan 和 Validation Plan 的一致版本生成；
- 7.5 F4 多角色审核、冲突处理、版本锁与不可自动发布的交付包；
- 7.6 F5 新基线、前后观察、控制实验的路径选择和 Result/Learning 回流；
- 7.7 F6 Product Fact、品牌术语、平台规则、Learning 与 Bad Case 运营；
- 7.8 F7 P1 条件性 Experiment Card 的资格、字段、状态和人工责任；
- 7.9 各功能输入、输出、状态和权限总表；
- 7.10 人工审核、实际发布、结果复盘和知识回流；
- 7.11 对象版本、组件版本、人工动作、错误和成本埋点。

关键产物 / Gate：七项功能闭环、状态与权限总表、审核和学习回流图；P0 功能均需追溯到用户问题、对象状态和验收证据。
