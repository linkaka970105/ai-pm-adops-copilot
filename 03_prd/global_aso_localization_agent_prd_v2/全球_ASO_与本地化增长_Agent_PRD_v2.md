...
- 支持任务受理、数据快照、评论与关键词洞察、竞品与素材分析、metadata 草案、Creative Brief、实验卡、人工审核和学习回流。
...
| 阅读遍次 | 只回答一个问题 | 阅读重点 | 必须留下的个人产物 |
| --- | --- | --- | --- |
| 第一遍：看业务 | 用户到底在完成什么高成本任务？ | 第 1—5 章 | 一张现状流程、三条业务证据、一个北极星问题 |
| 第二遍：看决策 | 为什么用这套方案，为什么不用其他方案？ | 第 4、5、8、21 章 | 一张替代方案表、三条 Decision Log |
| 第三遍：看落地 | 数据、模型、系统和人如何形成闭环？ | 第 6—16 章 | 一张本人手绘架构图、一张异常状态机、一份评测表 |
| 第四遍：看答辩 | 哪些结论有证据，哪些只是待验证假设？ | 第 17—22 章 | 3/5/10 分钟讲稿和 10 个约束追问 |

这份文档不是让你把“ASO + 本地化 + Agent”当成概念组合。真正需要学习的是：问题为什么成立 → 为什么需要 AI → 为什么选择这一范围 → 为什么这样拆任务 → 如何验证 → 失败后怎么办。当前项目是个人 PoC 与产品概念方案，不得包装成已上线经历。

### 每一节都用同一组问题阅读和迁移

1. Why：如果不做这一节，后续哪个决策会失去依据？

2. Why not：人工、SOP、规则、搜索、数据平台或更小方案为什么不足？

3. Know how：输入、处理、输出、状态、责任人、指标和异常分别是什么？

4. Evidence：结论来自公开资料、用户输入、访谈、日志、实验还是假设？证据放在哪里？

5. Boundary：最容易失败、越权或被误用的 Corner Case 是什么？

6. Migration：迁移到其他 App、品类或市场时，哪些变量必须重做？

7. Interview：面试官改变数据、成本、语言、安全或时延约束后，决策是否仍成立？

流程图学习要求：必须由学员本人手画

本文 Mermaid 图只展示“应该表达哪些节点和关系”。学习时请先关闭本文，依据自己的业务访谈和事实亲手画出第一版流程图或架构图，再回来对照。AI 只可用于检查漏项，不可替代业务判断。

交互稿与原型说明

本项目当前暂不提供任何页面图片或高保真原型。企业真实落地时必须补齐任务创建页、证据工作台、策略编辑页、实验卡、人工审核队列和质量看板的可点击原型，并标注角色、字段来源、状态、权限、危险动作、异常、恢复、埋点和验收。
...
| Experiment Card | 记录证据、假设、主变量、对照、指标、观察窗口、停止规则、干扰因素和结果的实验卡 |
| 人在回路 | 母语、品牌、策略、发布、实验与高风险合规均保留人工审核或确认 |
| PoC | 证明关键方法与质量可行，不等同于上线或证明业务增长 |
...
面向出海 App 的 ASO / App Growth 团队，提供一个基于公开或授权商店数据、产品事实、平台规则与历史实验的证据驱动增长决策 Agent，在不替代母语、品牌、合规、发布和增长决策的前提下，完成市场洞察、关键词意图、metadata 草案、Creative Brief、实验规划和学习回流。

## 1.2 目标用户、核心场景与关键痛点

| 用户 | 核心任务 | 关键痛点 |
| --- | --- | --- |
| ASO / App Growth 运营 | 为一个 App 进入新市场或迭代商店页，完成研究、方案和实验准备 | 跨工具复制整理，证据、版本和结论分散，任务依赖个人经验 |
...
| 视觉设计 / 创意策略 | 把市场洞察转成商店截图或视频版本 | Brief 模糊，文本与视觉卖点不一致，一次修改多个变量 |
| 增长负责人 | 审核投入、风险和实验优先级，复用跨市场经验 | ASO 过程不透明，结果难归因，组织能力依赖少数专家 |
...
- 提升关键词、评论、文案、素材和实验之间的一致性与证据可追溯性。

- 让产品事实、文化、品牌、平台规则和数据不足等风险更早进入正确的人工审核点。

- 将跨市场实验经验从个人记忆和分散文档转为受治理、有适用边界的增长知识。
...
- 将证据组织为结构化市场机会卡、metadata 草案、Creative Brief 和 Experiment Card。
...
flowchart TB
    ...
    D2["分析竞品定位与商店素材"]
    D3["检索产品事实、品牌术语与平台规则"]
    E["生成带证据的 metadata 草案与 Creative Brief"]
    F["母语、品牌、ASO 与合规人工确认"]
    G["生成单变量 Experiment Card"]
    H["人工发布或创建实验"]
    I{"结果是否足以形成结论？"}
...
| 类别 | 核心内容 |
| --- | --- |
| 北极星指标 | 经人工审核可进入实验排期的证据化策略包占比；正式口径和目标值待第 5、16 章冻结 |
| 质量指标 | 重要建议证据覆盖、引用正确、关键词相关、实验卡完整、人工采纳与修改 |
| 安全指标 | 产品事实幻觉、文化/品牌风险漏检、政策引用过期、越权访问或发布 |
| 关键风险 | 公开或第三方数据不完整、评论样本偏差、生成内容不自然、多变量实验难归因、证据维护负担过高 |
...
5. 母语、品牌、合规、实验和发布均保留人工责任；MVP 不自动发布。
...
**最该注意：** 区分用户抱怨与可被证据支持的根因。迁移时用访谈、流程观察、日志和样本建立现状基线；没有证据的写成待验证假设。 **面试常问：** 不做这个项目的成本是什么，为什么现在做？

当前流程和痛点来自产品方向、竞品分析与公开资料，尚未完成本项目的一手访谈、任务观察和日志基线；发生频率、耗时和损失均待验证。

## 2.1 行业、市场与业务背景

本项目不预设 ASO 市场规模或业务提升比例。需要确认的业务事实包括：目标团队每月商店页任务量、涉及市场和语言、参与角色、工具成本、研究与返工工时、当前实验质量、可用数据、审核责任和平台权限。

从工作流看，全球 ASO 与本地化增长存在三个结构性矛盾：

- 团队要求更快进入和迭代市场，但当地表达、品牌、规则和增长判断需要保持可信与可审核。

- 评论、关键词、竞品页面和素材高度非结构化，产品事实、平台规则、版本和实验要求相对结构化。

- 历史经验有价值，但不同 App、品类、市场、版本和流量条件下的结论不能直接复用为因果规律。
...
flowchart TB
    ...
    S4["审核发布<br/>动作：多角色修改、人工发布<br/>工具：IM、设计工具、商店后台"]
    S5["实验复盘<br/>动作：观察指标、比较版本、记录结论<br/>工具：实验后台、报表、文档"]

    P1["典型问题<br/>目标、产品事实与数据权限不完整"]
    P2["典型问题<br/>重复检索、来源和口径分散"]
    P3["典型问题<br/>文本、视觉与实验假设难关联"]
    P4["典型问题<br/>反复返工或一次改动多个变量"]
...
| 实验难归因 | 一次修改多个变量，结果未关联原始假设和版本 | Hypothesis、Experiment 与 Version 状态不完整 |
...
- 能连接“评论需求—搜索意图—卖点—metadata / Creative Brief—单变量实验”的任务。
...
对于为一个出海 App 进入新市场或迭代商店页的 ASO / App Growth 团队，现有流程因评论、关键词、竞品、产品事实、文本、视觉、版本和实验信息分散而重复、难协作且不可追溯。产品希望在不伪造数据、不替代母语、品牌、合规和增长决策、不自动发布的前提下，缩短符合质量 Gate 的首版方案准备时间，提高策略证据完整性，并让真实实验结果形成有适用边界的增长学习。

北极星问题：我们能否让 ASO / App Growth 运营基于可追溯证据，产出通过人工审核、可进入真实实验排期，并在实验后形成可复用学习的本地化增长方案？
