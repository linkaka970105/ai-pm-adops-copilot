# AdOps Copilot 投放归因排障助手 AI PRD - 汇总版

> 本文由 `01-decision.md`、`02-solution.md`、`03-implementation.md` 汇总生成。若本文与分层文档冲突，以分层文档为准，并先修正分层文档后重新生成本文。

## 目录

- [第零部分：项目摘要、商业论证与项目蓝图](#part-0)
  - [0.1 项目摘要](#section-0-1)
  - [0.2 商业目标与项目评估指标](#section-0-2)
  - [0.3 项目排期与里程碑](#section-0-3)
  - [0.4 所需人力与资源](#section-0-4)
  - [0.5 关键风险与缓解措施](#section-0-5)
- [第一部分：产品愿景与核心原则](#part-1)
- [第二部分：Agent 核心人设](#part-2)
- [第三部分：核心工作流与意图定义](#part-3)
- [实现层继承约束](#implementation-constraints)
- [第四部分：Agent 工作流、技术栈与实现](#part-4)
- [第五部分：知识库架构与数据管线](#part-5)
- [第六部分：AI 评估框架、数据集与 MLOps 管线](#part-6)
- [第七部分：安全兜底、Badcase 与人工接管机制](#part-7)
- [第八部分：用户画像与个性化架构](#part-8)
- [第九部分：成本、计量与性能](#part-9)
- [附件 A：数据集样例](#appendix-a)
<a id="part-0"></a>
...
<a id="implementation-constraints"></a>
